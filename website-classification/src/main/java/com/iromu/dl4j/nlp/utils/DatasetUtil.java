...
public class DatasetUtil {
    ...
    public static final Path datasetPath = Paths.get(System.getProperty("user.home"), "datasets", "website-classification");
...
//            datasetUtil.columndDataFormat(datasetUtil.list(datasetUtil.trainPath), datasetUtil.workingPath.resolve("stanford-classifier.train"));
    ...
    public DatasetUtil(DatasetNormalizer normalizer) {
        ...
        workingPath = Paths.get(System.getProperty("user.home"), "datasets", "website-classification-workdir", simpleName);
